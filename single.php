    ...
    <div class="postcontainer_single">
        ...
        <div class="imagecontainer_single">
            <div class="post" id="<?php the_ID() ?>" style="grid-row: 1 / span 2;">
                <div class="buttons">
                    <a style="cursor: default;" href="/shop"><img class="button1"
                            src="<?php echo get_template_directory_uri(). '/assets/button1.png'?>" alt=""></a>
                    <a class="button2" href=""><img
                            src="<?php echo get_template_directory_uri(). '/assets/button2.png'?>"
                            style="margin-left: 3px;" alt=""></a>
                </div>
